...
2018-06-14.  Go [here](./) for a list of all releases and
[here](http://caml.inria.fr/pub/distrib/ocaml-4.08/) for all 4.08.*
files.
...
- [Source
  tarball](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08.0.tar.gz)
  (.tar.gz) for compilation under Unix (including Linux and MacOS X)
  and Microsoft Windows (including Cygwin).
- Also available in
  [.tar.xz](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08.0.tar.xz)
  format.
...
The
[INSTALL](http://caml.inria.fr/pub/distrib/ocaml-4.08/notes/INSTALL.adoc) file
of the distribution provides detailed compilation and installation
instructions -- see also the [Windows release
notes](http://caml.inria.fr/pub/distrib/ocaml-4.08/notes/README.win32.adoc) for
...
* [Bucklescript](http://bucklescript.github.io/bucklescript/) is a
  ...
  [documentation](https://bucklescript.github.io/docs/en/comparison-to-jsoo) for
...
- [browsed
  online](http://caml.inria.fr/pub/docs/manual-ocaml-4.08/index.html),
- downloaded as a single
  [PostScript](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman.ps.gz),
  [PDF](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman.pdf),
  or [plain
  text](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman.txt)
  document,
- downloaded as a single
  [TAR](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman-html.tar.gz)
  or
  [ZIP](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman-html.zip)
  archive of HTML files,
- downloaded as a single
  [tarball](http://caml.inria.fr/pub/distrib/ocaml-4.08/ocaml-4.08-refman.info.tar.gz)
  of Emacs info files,
...
directory](http://caml.inria.fr/pub/distrib/ocaml-4.08), along with
...
This is the
[changelog](http://caml.inria.fr/pub/distrib/ocaml-4.08/notes/Changes).
...
- [#1182](https://github.com/ocaml/ocaml/pull/1182):
  Add new Printf formats %#d %#Ld %#ld %#nd (idem for %i and %u) for
...
- [#7843](https://github.com/ocaml/ocaml/pull/7843),
  ...
  ocamldoc, better handling of {{!label}text} in the latex
  backend.
...
- [#2264](https://github.com/ocaml/ocaml/pull/2264),
  ...
  the configure script now sets the Unicode handling mode
